...
define(function () {
    ...
    draw2d.Color.prototype.hex2rgb = function (_4f15) {
        _4f15 = _4f15.replace("#", "");
        return ({0:parseInt(_4f15.substr(0, 2), 16), 1:parseInt(_4f15.substr(2, 2), 16), 2:parseInt(_4f15.substr(4, 2), 16)});
    };
    ...
    draw2d.ResizeHandle.prototype.onDrag = function () {
        ...
        switch (this.type) {
            case 1:
                this.workflow.currentSelection.setPosition(_4e9b - diffX, _4e9c - diffY);
